...
var FigmaBotCommonActions = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        clientRect = _a.sent();
                        return [4 /*yield*/, page.mouse.click(clientRect.x + random(0, clientRect.width), clientRect.y + random(0, clientRect.height), {
    ...
    FigmaBotCommonActions.submitSingInForm = function (page, authData, delayDuration) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, wait(delayDuration)];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, page.click('form#auth-view-page > input[name="email"]')];
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, wait(delayDuration)];
                    case 3:
                        _a.sent();
