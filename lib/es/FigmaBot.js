...
import { ProjectCreationError, FileCreationError, AuthorizationError, FileRenameError, ProjectRenameError, DuplicateExternalFileError, RenameFileInProjectError } from './common/errors';
...
var FigmaBot = /** @class */ (function () {
    ...
    FigmaBot.prototype._signIn = function (page, authData) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, FigmaBotCommonActions.waitAndNavigate(page, page.goto('https://www.figma.com/login'))];
                    case 1:
                        _a.sent();
                    ...
                    case 2:
                        _a.trys.push([2, 4, , 5]);
                        return [4 /*yield*/, FigmaBotCommonActions.waitAndNavigate(page, FigmaBotCommonActions.submitSingInForm(page, authData))];
                    case 3:
                        _a.sent();
                        return [3 /*break*/, 5];
                    case 4:
                        e_1 = _a.sent();
                        throw new AuthorizationError(e_1);
                    case 5:
                        url = page.url();
                    ...
                    case 9:
                        ...
                        return [4 /*yield*/, FigmaBotCommonActions.parseLoginPageError(page)];
                    case 10:
                        error = _a.sent();
                        throw new AuthorizationError(error || 'unknown error');
                    case 11: throw new AuthorizationError("Unexpectedly redirected to \"" + url + "\"");
    ...
    FigmaBot.prototype._confirmAuth = function (page, authData) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, FigmaBotCommonActions.checkAuth(page)];
                    case 1:
                    ...
                    case 6:
                        e_2 = _a.sent();
                        throw new AuthorizationError(e_2);
                    case 7: return [4 /*yield*/, FigmaBotCommonActions.checkAuth(page)];
                    case 8:
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!projectName) {
                            throw new ProjectCreationError('Parameter "projectName" must be a non-empty string', teamId);
                        }
                    ...
                    case 3:
                        _a.sent();
                        return [4 /*yield*/, FigmaBotCommonActions.goToTeamPage(page, teamId)];
                    case 4:
                        _a.sent();
                    ...
                    case 5:
                        ...
                        return [4 /*yield*/, wait(this.delayDuration)];
                    case 6:
                        _a.sent();
                        return [4 /*yield*/, FigmaBotCommonActions.click(page, newProjectButtonHandle)];
                    case 7:
                        _a.sent();
                    ...
                    case 14:
                        _a.sent();
                        return [4 /*yield*/, FigmaBotCommonActions.waitAndNavigate(page, FigmaBotCommonActions.click(page, createProjectButtonHandle))];
                    case 15:
                        _a.sent();
                        return [3 /*break*/, 18];
                    case 16:
                    ...
                    case 17:
                        _a.sent();
                        throw new ProjectCreationError(e_3, teamId, projectName);
                    case 18:
                    ...
                    case 19:
                        _a.sent();
                        throw new ProjectCreationError("Unexpectedly redirected to \"" + url + "\". Note that project still could be created.", teamId, projectName);
                    case 20:
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!fileName) {
                            throw new FileCreationError('Parameter "fileName" must be a non-empty string', projectId);
                        }
                    ...
                    case 3:
                        _a.sent();
                        return [4 /*yield*/, FigmaBotCommonActions.goToProjectPage(page, projectId)];
                    case 4:
                        _a.sent();
                        return [4 /*yield*/, FigmaBotCommonActions.findElement(page, {
                    ...
                    case 6:
                        _a.sent();
                        return [4 /*yield*/, FigmaBotCommonActions.click(page, newFileButtonHandle)];
                    case 7:
                        _a.sent();
                        return [3 /*break*/, 10];
                    case 8:
                    ...
                    case 9:
                        _a.sent();
                        throw new FileCreationError(e_4, projectId, fileName);
                    case 10: return [4 /*yield*/, FigmaBotCommonActions.waitForRedirects({ page: page })];
                    case 11:
                        _a.sent();
                        url = page.url();
                    ...
                    case 12:
                        _a.sent();
                        throw new FileCreationError("Unexpectedly redirected to \"" + url + "\". Note that file still could be created, but named \"Untitled\"", projectId, fileName);
                    case 13:
                        fileId = url.split('/')[4];
                        _a.label = 14;
                    case 14:
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        _a.sent();
                        return [4 /*yield*/, FigmaBotCommonActions.goToFilePage(page, fileId)];
                    case 4:
                        _a.sent();
                        return [4 /*yield*/, FigmaBotCommonActions.waitForRedirects({ page: page })];
                    case 5:
                        _a.sent();
                    ...
                    case 14:
                        e_6 = _a.sent();
                        throw new FileRenameError(e_6, fileId, newName);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 7:
                        _a.sent();
                        return [4 /*yield*/, FigmaBotCommonActions.click(page, projectOptionsHandle)];
                    case 8:
                        _a.sent();
                        return [4 /*yield*/, FigmaBotCommonActions.findElement(page, {
                    ...
                    case 10:
                        _a.sent();
                        return [4 /*yield*/, FigmaBotCommonActions.click(page, renameButtonHandle)];
                    case 11:
                        _a.sent();
                        return [4 /*yield*/, FigmaBotCommonActions.findElement(page, {
                    ...
                    case 13:
                        _a.sent();
                        return [4 /*yield*/, FigmaBotCommonActions.clearInput(page, input)];
                    case 14:
                        _a.sent();
                        return [4 /*yield*/, wait(this.delayDuration)];
                    case 15:
                    ...
                    case 20:
                        e_7 = _a.sent();
                        throw new ProjectRenameError(e_7, projectId, newName);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        _a.label = 2;
                    case 2:
                        _a.trys.push([2, 38, 39, 41]);
                        return [4 /*yield*/, this._confirmAuth(page)];
                    case 3:
                        _a.sent();
                        // open project page [sourceProjectId]
                        return [4 /*yield*/, FigmaBotCommonActions.goToProjectPage(page, sourceProjectId)];
                    case 4:
                        // open project page [sourceProjectId]
                        _a.sent();
                        return [4 /*yield*/, wait(this.delayDuration)];
                    ...
                    case 7:
                        _a.sent();
                        return [4 /*yield*/, FigmaBotCommonActions.click(page, sourceFileButtonHandle, 'right')];
                    case 8:
                        _a.sent();
                        return [4 /*yield*/, wait(this.delayDuration)];
                    case 9:
                    ...
                    case 12:
                        _a.sent();
                        return [4 /*yield*/, FigmaBotCommonActions.click(page, duplicateFileButtonHandle)];
                    case 13:
                        _a.sent();
                        return [4 /*yield*/, wait(this.delayDuration)];
                    case 14:
                    ...
                    case 16:
                        _a.sent();
                        return [4 /*yield*/, FigmaBotCommonActions.click(page, copyFileButtonHandle, 'right')];
                    case 17:
                        _a.sent();
                        return [4 /*yield*/, wait(this.delayDuration)];
                    case 18:
                    ...
                    case 21:
                        _a.sent();
                        return [4 /*yield*/, FigmaBotCommonActions.click(page, moveCopyFileButtonHandle)];
                    case 22:
                        _a.sent();
                        return [4 /*yield*/, wait(this.delayDuration)];
                    case 23:
                    ...
                    case 30:
                        _a.sent();
                        return [4 /*yield*/, FigmaBotCommonActions.click(page, destinationProjectInModal)];
                    case 31:
                        _a.sent();
                        return [4 /*yield*/, wait(this.delayDuration)];
                    case 32:
                    ...
                    case 35:
                        _a.sent();
                        return [4 /*yield*/, FigmaBotCommonActions.click(page, moveCopyFileInModalButtonHandle)];
                    case 36:
                        _a.sent();
                        return [4 /*yield*/, wait(this.delayDuration)];
                    case 37:
                    ...
                    case 38:
                        e_8 = _a.sent();
                        throw new DuplicateExternalFileError(e_8, sourceProjectId, sourceFileName);
                    case 39: return [4 /*yield*/, page.close()];
                    case 40:
                        _a.sent();
                        return [7 /*endfinally*/];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 12:
                        _a.sent();
                        return [4 /*yield*/, FigmaBotCommonActions.click(page, renameFileButtonHandle)];
                    case 13:
                        _a.sent();
                        return [4 /*yield*/, wait(this.delayDuration)];
                    case 14:
                    ...
                    case 20:
                        e_9 = _a.sent();
                        throw new RenameFileInProjectError(e_9, sourceProjectId, sourceFileName);
                    case 21: return [4 /*yield*/, page.close()];
                    case 22:
                        _a.sent();
                        return [7 /*endfinally*/];
